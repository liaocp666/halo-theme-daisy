...
<div class="flex flex-col lg:flex-row">
    ...
    <div class="flex flex-col lg:pl-[330px] w-full">
        <div class="page-title my-20 mx-auto lg:page-mqx-width w-full lg:px-[40px] flex flex-col space-y-3">
            <h1 class="text-4xl font-black subpixel-antialiased dark:text-white" id="fillTitle">${settings.journals_title}</h1>
        </div>
            ...
            <div class="page-content journals lg:w-[100%]">
                <#list journals.content as journal>
                    <div class="page-item hover:shadow-lg duration-300 mb-12">
                        <div class="page-content bg-white dark:bg-neutral-900 p-8 text-767676 flex flex-col space-y-3">
                        ...
                        <div class="journal-comment-div bg-white dark:bg-neutral-900 p-8 hover:shadow-lg  mb-12" hidden>
