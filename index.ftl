...
<div class="flex flex-col lg:flex-row">
    <@header/>
    <div class="w-full flex flex-col lg:flex-row h-screen justify-center content-center items-center lg:space-x-16 lg:pl-[450px]">
        <div class="avatar lg:pl-64 mb-6 lg:mb-0">
        ...
        <div class="resume lg:pr-64 space-y-6">
